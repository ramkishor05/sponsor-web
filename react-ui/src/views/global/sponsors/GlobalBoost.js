...
class GlobalBoost extends Component {
    state={
        saveModel: false,
        deleteModel: false,
        dataObject: {},
...
const mapStateToProps = state => {
    ...
    const { globalSponsorPageData } = state.globalSponsorReducer;

    return { globalSponsorPageData };
};


export default connect(mapStateToProps, { getGlobalSponsorPageList, addGlobalSponsor, editGlobalSponsor, deleteGlobalSponsor })(GlobalBoost);
