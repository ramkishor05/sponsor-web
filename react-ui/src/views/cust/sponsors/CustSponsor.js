...
class CustSponsor extends Component {
    state={
        saveModel: false,
        deleteModel: false,
        dataObject: {},
...
export default connect(mapStateToProps, {getGlobalSponsorPageList, addGlobalSponsor, editGlobalSponsor, deleteGlobalSponsor })(CustSponsor);
