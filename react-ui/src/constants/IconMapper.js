...
import LevelIcon from '@mui/icons-material/Brightness5';
import BoastIcon from '@mui/icons-material/DirectionsBoat';
import RoyaltyIcon from '@mui/icons-material/EuroSymbol';
...
export const IconMapper = {
    ...
    Sponsor: ManageAccountsIcon,
    Level: LevelIcon,
    Boast: BoastIcon,
    Royalty: RoyaltyIcon,
    Financial:AccountBalanceIcon,
    Boost: InsertInvitationIcon,
